...
answer_holder="";
score=0;
sketch_to_drawn= sketch;

function draw(){
   check_sketch();
   if(drawn_sketch==sketch_to_drawn){
       answer_holder="set";
       score=score+1;
